                                  ...
                                  return SimpleDialog(
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        padding: EdgeInsets.all(10.0),
                                        child: Text(
                                          "Complaints : Pain among the rashes that appear during the day",
                                        ),
                                      ),
                                      Padding(
                                        padding: EdgeInsets.all(10.0),
                                      ...
                                      Padding(
                                        ...
                                        child: new Image.asset('assets/sample3.jpg')
                                      ),
                                      Padding(
                                        padding: EdgeInsets.all(10.0),
                                        child: Text(
                                          "Diagnose Results : NotMelanoma",
                                        ),
                                      ),
                                      Padding(
                                        padding: EdgeInsets.all(10.0),
                                        child: Text(
                                          "Confidence Rate : 99.9999%",
                                        ),
                                      ),
                                      Padding(
